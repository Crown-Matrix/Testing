...
## IndexOf(data)
--Returns index of first occurence in linked list with node of same data

## contains(data)
--Returns True/False if data is within list

## isEmpty()
--return True/False if linked list is empty
...
## LastIndexOf(data)
--returns index of last occurence in linked list with node of same data

## deleteData(data)
--deletes first occurence of node with given data

## deleteLastData(data)
--deletes last occurence of node with given data
